...
function start() {
  return i18n
    ...
    .then(function() {
      ...
      log.info(
        os.type() + ' ' + os.release() + ' ' + os.arch() + ' ' + os.endianness()
      )
      return redNodes
        .load()
        .then(function() {
          ...
          if (settings.settingsFile) {
            log.info(
              log._('runtime.paths.settings', { path: settings.settingsFile })
            )
          }
          console.log('redNodes.loadFlows() runtime')
