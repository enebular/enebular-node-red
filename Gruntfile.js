...
module.exports = function(grunt) {
  ...
  grunt.initConfig({
    ...
    jshint: {
      ...
      core: {
        files: {
          src: ['Gruntfile.js', 'red.js', 'red/**/*.js']
        }
      },
      nodes: {
        files: {
    ...
    uglify: {
      build: {
        files: {
          ...
          'public/vendor/ace/mode-jsonata.js':
    ...
    chmod: {
      ...
      release: {
        src: [
          path.resolve(
            '<%= paths.dist %>/node-red-<%= pkg.version %>/nodes/core/hardware/nrgpio*'
          ),
          path.resolve(
            '<%= paths.dist %>/node-red-<%= pkg.version %>/red/runtime/storage/localfilesystem/projects/git/node-red-*sh'
          )
        ]
      }
    },
